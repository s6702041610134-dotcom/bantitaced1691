...
const styles = StyleSheet.create({
  ...
  weatherModalCard: { borderTopLeftRadius: 32, borderTopRightRadius: 32, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, width: '100%', maxHeight: '85%', padding: 24, paddingTop: 12, backgroundColor: 'rgba(250, 246, 240, 0.98)' },
