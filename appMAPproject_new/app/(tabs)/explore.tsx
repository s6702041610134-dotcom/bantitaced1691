...
const styles = StyleSheet.create({
  ...
  badgeCategoryText: { fontFamily: 'Inter_600SemiBold', fontSize: 11, color: Colors.freshlyRoasted },
  badgeRating: {
    position: 'absolute',
    top: 12,
    right: 12,
  ...
  badgeRatingText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.freshlyRoasted },

  placeDetails: { padding: 14 },
  titleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  placeName: { fontFamily: 'CormorantGaramond_600SemiBold', fontSize: 20, color: Colors.freshlyRoasted, flex: 1 },
  userAddedTag: { backgroundColor: '#FEF3C7', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 4, marginLeft: 6 },
  userAddedTagText: { fontSize: 9, fontFamily: 'Inter_600SemiBold', color: '#D97706' },
  placeDistrict: { fontFamily: 'Inter_400Regular', fontSize: 12, color: 'rgba(75, 46, 31, 0.7)', marginVertical: 4 },
  placeDesc: { fontFamily: 'Inter_400Regular', fontSize: 13, color: 'rgba(75, 46, 31, 0.85)', lineHeight: 18 },
  ...
  actionBtnOutline: {
    ...
    borderRadius: 999,
    borderWidth: 1,
    borderColor: 'rgba(75, 46, 31, 0.25)',
    backgroundColor: 'rgba(255, 255, 255, 0.5)',
  },
  actionBtnOutlineText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.freshlyRoasted },
  actionBtnPrimary: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
  ...
  actionBtnPrimaryText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.oldLace },
  ...
  // Detail Modal
  detailModalCard: { borderTopLeftRadius: 32, borderTopRightRadius: 32, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, height: '85%', padding: 0, backgroundColor: 'rgba(255, 255, 255, 0.88)' },
  ...
  detailCategoryText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: Colors.freshlyRoasted },
  detailBody: { padding: 24 },
  detailTitleRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  detailTitle: { fontFamily: 'Inter_700Bold', fontSize: 22, color: '#111', flex: 1 },
  detailRatingChip: { flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#FEF3C7', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999 },
  detailRatingText: { fontFamily: 'Inter_600SemiBold', fontSize: 12, color: '#D97706' },
  detailNameEn: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#666', marginTop: 2 },
  detailDistrictChip: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 8 },
  detailDistrictText: { fontFamily: 'Inter_500Medium', fontSize: 13, color: Colors.freshlyRoasted },
  divider: { height: 1, backgroundColor: 'rgba(0,0,0,0.06)', marginVertical: 16 },
  sectionLabel: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: '#111', marginBottom: 6 },
  detailDescription: { fontFamily: 'Inter_400Regular', fontSize: 14, color: '#444', lineHeight: 22, marginBottom: 14 },
  detailTips: { fontFamily: 'Inter_400Regular', fontSize: 13, color: '#333', lineHeight: 20, backgroundColor: 'rgba(240, 237, 232, 0.7)', padding: 14, borderRadius: 16 },

  detailActionRow: { flexDirection: 'row', gap: 12, marginTop: 14 },
  detailNavBtn: { flex: 1, borderRadius: 999 },
  detailNavBtnText: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: Colors.freshlyRoasted, marginLeft: 6 },
  detailAddTripBtn: { flex: 1, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#1E1E1E', borderRadius: 999, paddingVertical: 14, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 3 },
  detailAddTripBtnText: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: '#FFFFFF' },

  // Add Trip Modal
  addTripModalCard: { borderRadius: 32, padding: 24, backgroundColor: 'rgba(255, 255, 255, 0.88)' },
  modalHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12, paddingBottom: 10, borderBottomWidth: 1, borderBottomColor: 'rgba(0,0,0,0.06)' },
  modalHeaderTitle: { fontFamily: 'Inter_700Bold', fontSize: 18, color: '#111' },
  targetPlaceName: { fontFamily: 'Inter_500Medium', fontSize: 13, color: '#666', marginBottom: 10 },
  tripItemCard: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 14, borderRadius: 16, backgroundColor: '#FFFFFF', marginBottom: 8, borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)', shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.03, shadowRadius: 3, elevation: 1 },
  tripItemInfo: { flexDirection: 'row', alignItems: 'center', gap: 10, flex: 1 },
  tripItemName: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#111', flex: 1 },
  tripItemCount: { fontFamily: 'Inter_400Regular', fontSize: 11, color: '#777' },

  createTripBtnOutline: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingVertical: 14, borderRadius: 999, borderWidth: 1.5, borderColor: '#1E1E1E', backgroundColor: '#FFFFFF' },
  createTripBtnText: { fontFamily: 'Inter_600SemiBold', fontSize: 14, color: '#1E1E1E' },
  newTripInputWrap: { marginTop: 8 },
  modalInput: { backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', borderRadius: 16, paddingHorizontal: 16, paddingVertical: 12, fontFamily: 'Inter_400Regular', fontSize: 14, color: '#111', marginBottom: 12 },
  newTripActionRow: { flexDirection: 'row', justifyContent: 'flex-end', gap: 10 },
  cancelSmallBtn: { paddingHorizontal: 16, paddingVertical: 10, borderRadius: 999, borderWidth: 1.5, borderColor: '#FF4D4F', backgroundColor: '#FFFFFF' },
  cancelSmallText: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#FF4D4F' },
  confirmSmallBtn: { backgroundColor: '#1E1E1E', paddingHorizontal: 18, paddingVertical: 10, borderRadius: 999 },
  confirmSmallText: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#FFFFFF' },

  // Create Post Modal
  createPostModalCard: { borderTopLeftRadius: 32, borderTopRightRadius: 32, borderBottomLeftRadius: 0, borderBottomRightRadius: 0, maxHeight: '90%', padding: 24, backgroundColor: 'rgba(255, 255, 255, 0.88)' },
  largePostImageWrap: { width: 140, height: 140, backgroundColor: '#fff', padding: 6, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.1, shadowRadius: 10, elevation: 4 },
  largePostImage: { width: '100%', height: '100%', borderRadius: 14 },
  largePostImagePlaceholder: { width: 140, height: 140, backgroundColor: 'rgba(240, 237, 232, 0.8)', borderRadius: 20, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: 'rgba(0,0,0,0.06)' },
  btnPickPhotoPill: { flexDirection: 'row', alignItems: 'center', gap: 6, marginTop: 12, backgroundColor: 'rgba(240, 237, 232, 0.9)', paddingHorizontal: 16, paddingVertical: 10, borderRadius: 999, borderWidth: 1, borderColor: 'rgba(0,0,0,0.05)' },
  btnPickPhotoPillText: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#222' },
  formLabel: { fontFamily: 'Inter_600SemiBold', fontSize: 13, color: '#333', marginTop: 12, marginBottom: 6 },
  catSelectChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 999, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: 'rgba(0,0,0,0.08)', marginRight: 8 },
  catSelectChipActive: { backgroundColor: '#1E1E1E', borderColor: '#1E1E1E' },
  catSelectText: { fontFamily: 'Inter_500Medium', fontSize: 12, color: '#333' },
  catSelectTextActive: { color: '#FFFFFF', fontFamily: 'Inter_600SemiBold' },
  submitPostBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: '#1E1E1E', paddingVertical: 14, borderRadius: 999, marginTop: 16, shadowColor: '#000', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.15, shadowRadius: 8, elevation: 3 },
  submitPostBtnText: { fontFamily: 'Inter_600SemiBold', fontSize: 15, color: '#FFFFFF' },
});
